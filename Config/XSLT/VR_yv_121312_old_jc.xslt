...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!--<xsl:template name="part1">
    ...
    <xsl:variable name="defectInformation">
      <xsl:value-of select="/ValuationReport/Document/Defects/Defect[$element]/DefectCtrlPoint"/>
      <xsl:text> </xsl:text>
      <xsl:value-of select="/ValuationReport/Document/Defects/Defect[$element]/DefectGrade"/>
      <xsl:text> </xsl:text>
      <xsl:value-of select="/ValuationReport/Document/Defects/Defect[$element]/DefectDescription"/>
    </xsl:variable>
    ...
    <xsl:if test="string-length($defectInformation) &lt;= 80">
      <Defect>
        ...
        <DefectPrice>
          <xsl:value-of select="/ValuationReport/Document/Defects/Defect[$element]/DefectPrice"/>
        </DefectPrice>
        <DefectInformation>
          <xsl:value-of select="/ValuationReport/Document/Defects/Defect[$element]/DefectCtrlPoint"/>
          <xsl:text> </xsl:text>
  ...
  <xsl:template match="/ValuationReport/Document/Defects/Defect">
	...
	<!--<xsl:template name="part3">
		...
		<xsl:if test="$element &lt;= $defects or $element &lt;= ($options - 21)">
			<xsl:if test="$defects &gt; 21 or ($options - 21) &gt; 21">
				<row>
					<DefectCtrlPoint>
						<xsl:value-of select="/ValuationReport/Document/Defects/Defect[$element]/DefectCtrlPoint"/>
					</DefectCtrlPoint>
					...
					<OptionDesc>
						<xsl:value-of select="/ValuationReport/Document/Options/Option[$element + 21]/OptionDesc"/>
					</OptionDesc>
				</row>
